        ...
        <div class="carrucelweb">
                    ...
                    <div id="carrusel1" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner">
                                <div class="carousel-item active">
                                  <img src="img/Lote2/foto1.jpg" alt="Los Angeles" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote2/foto2.jpg" alt="Chicago" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote2/foto3.jpg" alt="New York" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote2/foto4.jpg" alt="New York" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote2/foto5.jpg" alt="New York" width="100%" height="">
                                </div>
                          </div>
            ...
            <div class="carrucelMobile">
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                    <div class="carousel-item active">
                                      <img src="img/Lote2/photo1.jpg" alt="Los Angeles" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote2/photo2.jpg" alt="Chicago" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote2/photo3.jpg" alt="New York" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote2/photo4.jpg" alt="New York" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote2/photo5.jpg" alt="New York" width="100%" height="">
                                    </div>
                              </div>
                ...
                <div class="container">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-xs-10 col-md-12">
                                                <p class="infpt"><strong>Lote 2:</strong> 425m2 con frente a calle p&uacute;blica y <strong>hermosa vista</strong></p>
