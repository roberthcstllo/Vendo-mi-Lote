...
<!--                    <div class="container">
        ...
        <div class="carrucelweb">
                    ...
                    <div id="carrusel1" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner">
                                <div class="carousel-item active">
                                  <img src="img/Lote1/foto4.jpg" alt="Los Angeles" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote1/foto2.jpg" alt="Chicago" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote1/foto3.jpg" alt="New York" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote1/foto1.jpg" alt="New York" width="100%" height="">
                                </div>
                                <div class="carousel-item">
                                  <img src="img/Lote1/foto5.jpg" alt="New York" width="100%" height="">
                                </div>
                          </div>
            ...
            <div class="carrucelMobile">
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                    <div class="carousel-item active">
                                      <img src="img/Lote1/photo4.jpg" alt="Los Angeles" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote1/photo2.jpg" alt="Chicago" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote1/photo3.jpg" alt="New York" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote1/photo1.jpg" alt="New York" width="100%" height="">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="img/Lote1/photo5.jpg" alt="New York" width="100%" height="">
                                    </div>
                              </div>
            ...
            <div class="Infolotes">
                <div class="container">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-xs-10 col-md-12">
                                                <p class="infpt"><strong>Lote 1:</strong> 425m2 con frente a calle p&uacute;blica y <strong>hermosa vista</strong></p>
                ...
                <div class="container">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-xs-10 col-md-12">
                                                <p class="textprop">Le ofrecemos un lote con una vista privilegiada. Este est&aacute; ubicado en Chilamate de Po&aacute;s con un area de 425 m2 listos para construir. Con 11 metros de frente y sobre calle p&uacute;blica. Este lote tiene acceso a servicios de agua, luz e internet. Es una propiedad que fue dise&ntilde;ada especialmente para aprovechar su hermosa vista panor&aacute;mica y la mayor cantidad de espacio &uacute;til para construcci&oacute;n. Al lado de esta propiedad se emcuentra otro lote con mismo tama&ntilde;o y condiciones. sSte puede ser adquirido por el mismo comprador quien recibir&aacute; un precio especial por la adquisici&oacute;n de ambas propiedades.  </p>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-xs-6 col-md-6">
                                                <div class="col-xs-3 col-md-3">
                                                 ...
                                                 <div class="col-xs-9 col-md-9">
                                                    <p class="extinf">Alajuela, Po&aacute;s, <strong>Chilamate,</strong> Calle chaperno.</p>
                                                </div>
                                            </div>
                            ...
                            <div class="container">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12">
                                                    <p class="direction">Alajuela, Po&aacute;s, Chilamate, <strong>Calle chaperno</strong>, 150mtrs Sur</p>
                                                </div>
                ...
                <div>
                    <div class="container">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12">
                                                    <p class="buyls">Opci&oacute;n de compra de Lote 1 + Lote 2</p>
                        ...
                        <div class="container">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-xs-10 col-md-10">
                                                    <p class="text2l">Existe la opci&oacute;n de comprar ambos lotes juntos. Al hacer la compra de ambos el costo total ser&iacute;a de <strong>&#8353; 31.000.000</strong></p>
                        ...
                        <div class="container">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <div class="col-xs-12 col-md-12">
                                                        ...
                                                        <img class="picview" src="img/LotesJuntos.jpg">
                                                </div>
    ...
    <a onclick="sendWhatsappMessage()" class="phonelink"><div id="myButton"></div></a>
